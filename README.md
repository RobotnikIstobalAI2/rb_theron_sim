...
cd catkin_ws
vcs import --input \
  https://raw.githubusercontent.com/RobotnikAutomation/rb_theron_sim/noetic-0.1.1/repos/rb_theron_sim.repos.yaml
...
| `VERSION`            | `0.1.1`       | Repository version (branch or tag)            |
